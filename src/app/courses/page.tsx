      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-6 pt-4 md:pt-8">
          ...
          <div className="w-full md:w-auto flex flex-col sm:flex-row gap-3">
            ...
            <button className="bg-white/5 border border-white/10 rounded-full px-6 py-2.5 flex items-center justify-center gap-2 hover:bg-white/10 transition-colors w-full sm:w-auto shrink-0">
              <Filter size={18} />
